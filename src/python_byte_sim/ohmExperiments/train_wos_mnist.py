...
if __name__ == '__main__':
    ...
    print(f'I have {num1s} 1s and {numNot} others')
    ...
    for cepoch in range(0,numEpochs):
        ...
        if ((cepoch % 10) == 0): 
            ...
            modelName = "mymnist_model_" + str(cepoch) + ".pth" 
            torch.save(model.state_dict(), modelName)      

            vname = 'mymnist_loss.pkl'
            with open(vname, 'wb') as f:
                pickle.dump(trn_loss, f)
            tname = 'mymnist_error.pkl'
